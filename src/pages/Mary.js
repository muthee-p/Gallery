...
import MaryDp from '../assets/mary.jpg';
import MaryOne from '../assets/mary1.png';
import MaryTwo from '../assets/mary2.png';
import MaryThree from '../assets/mary3.png';
import MaryFour from '../assets/mary4.png';
import MaryFive from '../assets/mary5.png';
import MarySix from '../assets/mary6.png';


const Mary = () => {
  return (
    <div className="content">
    <h2 className='mb-4 text-center'>MARY WAMBUI </h2>
    <div className='flex justify-center items-center mb-12'>
    <img src={MaryDp} className='w-[30%] rounded-2xl' />
